...
if( $gameSwitches.value(99) && !$gameParty.members()[0].isAlive())
{
...
if( $gameSwitches.value(98) && !$gameParty.members()[1].isAlive())
{
			this._sequenceInputIsComplete = true;
			if(this._logWindow._waitMode === 'sequence-input') {
				this.endSequenceInput();
...
if( $gameSwitches.value(97) && !$gameParty.members()[2].isAlive())
{
			this._sequenceInputIsComplete = true;
			if(this._logWindow._waitMode === 'sequence-input') {
				this.endSequenceInput();
...
//    console.log(this._sequenceInputWaitLimit);
};
