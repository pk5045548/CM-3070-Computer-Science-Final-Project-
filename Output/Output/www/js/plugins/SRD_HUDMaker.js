    ...
    Sprite_HUDObject.prototype.updateAnimation = function(mainVar, spd, loop, min, max, dirVar) {
        ...
        if(spd==4.1/360){
            ...
            if(!loop) {
                ...
                else if(this[mainVar] >= max && this[dirVar] > 0) {
                    this[mainVar] = max;
                    this[dirVar] = -1;
                }
 ...
 */
    ...
    Sprite_HUDText.prototype.refreshProperties = function() {
        ...
        //        this.bitmap.textColor(this.powerUpColor());
//        if($gameSwitches.value(70))
//        {
//            this.bitmap.textColor = "#90ff66";
//        }
//        else if($gameSwitches.value(71))
//        {
//            this.bitmap.textColor = "#ec01f5";
//        }
 ...
 */
    ...
    Sprite_HUDTextEx.prototype.resetFontSettings = function() {
        ...
        $gameVariables.setValue(55, $gameVariables.value(58).length);

        if($gameSwitches.value(70))
        {
            this.contents.textColor = "#ec01f5";
        }
        else if($gameSwitches.value(71))
        {
            this.contents.textColor = "#ec01f5";
