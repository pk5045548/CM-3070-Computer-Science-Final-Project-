...
Window_Base.prototype.normalColor = function() {
    ...
    {
        $gameVariables.setValue(56,7);
    }
    else if($gameSwitches.value(69))
    {
        $gameVariables.setValue(56,8);
    }
    else if($gameSwitches.value(70))
    {
        $gameVariables.setValue(56,1);
    }
    else if($gameSwitches.value(71))
    {
        $gameVariables.setValue(56,2);
    }
    else if($gameSwitches.value(72))
    {
        $gameVariables.setValue(56,3);
    }
    else
    {
        $gameVariables.setValue(56,0);
    }
    return   this.textColor($gameVariables.value(56));
};
...
Window_Base.prototype.systemColor = function() {
    ...
    {
        $gameVariables.setValue(55,5);
    }
    else if($gameSwitches.value(72))
    {
        $gameVariables.setValue(55,6);
    }
    else
    {
    ...
    return   this.textColor($gameVariables.value(55));
};
...
Window_Base.prototype.drawGauge = function(x, y, width, rate, color1, color2) {
    ...
    this.contents.fillRect(x, gaugeY, width, 20, color1);
    this.contents.fillRect(x+5, gaugeY+5, width-10, 10, this.tpGaugeColor1());
    this.contents.fillRect(x+5, gaugeY+5, rate*(width-10), 10, color2);
};
...
Window_Base.prototype.drawActorName = function(actor, x, y, width) {
    ...
    if($gameSwitches.value(101)){
        this.changeTextColor(this.hpColor());
    }
    else{
        this.changeTextColor(this.normalColor());   
    }
    this.drawText(actor.name(), x, y-35, width);
...
Window_Base.prototype.drawActorClass = function(actor, x, y, width) {
    ...
    this.drawText(actor.currentClass().name, x, y-35, width);
};
...
Window_Base.prototype.drawActorLevel = function(actor, x, y) {
    ...
    this.drawText(TextManager.levelA, x, y-35, 48);
    this.changeTextColor(this.normalColor());
    this.drawText(actor.level, x + 84, y-35, 36, 'right');
};
...
Window_Base.prototype.drawCurrentAndMax = function(current, max, x, y,
    ...
    if (x3 >= x + labelWidth) {
        ...
        this.drawText(current, x3-10, y-35, valueWidth, 'right');
        this.drawText('  /', x2, y-35, slashWidth, 'right');;       
        this.drawText(max, x1, y-35, valueWidth, 'right');
    } else {
        this.changeTextColor(color1);
        this.drawText(current, x1, y-35, valueWidth, 'right');
    }
};
...
Window_Base.prototype.drawActorHp = function(actor, x, y, width) {
    ...
    var color3 = this.systemColor();
    this.drawGauge(x, y-25, width, actor.hpRate(), color1, color2);
    this.changeTextColor(this.systemColor());


    if($gameSwitches.value(70))
    {
        this.drawIcon(12, x-4, y-35);
    }
    else if($gameSwitches.value(71))
    {
        this.drawIcon(13, x-4, y-35);
    }
    else if($gameSwitches.value(72))
    {
        this.drawIcon(14, x-4, y-35);
    }
    else{
        this.drawIcon(15, x-4, y-35);
    }

    this.drawCurrentAndMax(actor.hp, actor.mhp, x, y, width,
                           this.hpColor(actor), this.hpColor(actor), color3);
};
...
Window_Base.prototype.drawActorMp = function(actor, x, y, width) {
    ...
    var color3 = this.tpCostColor();
    this.drawGauge(x, y-5, width, actor.mpRate(), color1, color2);
    this.changeTextColor(this.systemColor());
    // this.drawText(TextManager.mpA, x, y-15, 44);
    if($gameSwitches.value(70))
    {
        this.drawIcon(28, x-3, y-10);
    }
    else if($gameSwitches.value(71))
    {
        this.drawIcon(29, x-3, y-10);
    }
    else if($gameSwitches.value(72))
    {
        this.drawIcon(30, x-3, y-10);
    }
    else{
        this.drawIcon(32, x-3, y-10);
    }

    this.drawCurrentAndMax(actor.mp, actor.mmp, x, y+20, width,
                           this.mpColor(actor),this.mpColor(actor), color3);
};
...
Window_Base.prototype.drawItemName = function(item, x, y, width) {
    ...
    if (item) {
        ...
        this.drawText(item.name, x+10, y, width);
    }
};
...
Window_Command.prototype.initialize = function(x, y) {
    ...
    Window_Selectable.prototype.initialize.call(this, x+10, y, width, height);
    this.refresh();
    this.select(0);
    this.activate();
};
...
Window_MenuActor.prototype.initialize = function() {
    Window_MenuStatus.prototype.initialize.call(this, 0, 100);
    this.hide();
};
...
Window_SkillList.prototype.drawSkillCost = function(skill, x, y, width) {
    if (this._actor.skillTpCost(skill) > 0) {
        ...
        this.changeTextColor(4);
        this.drawText(this._actor.skillMpCost(skill), x, y, width, 'center');
    }
};
...
Window_EquipSlot.prototype.drawItem = function(index) {
    if (this._actor) {
        ...
        this.changeTextColor(this.normalColor());
        this.drawItemName(this._actor.equips()[index], rect.x + 148, rect.y);
        this.changePaintOpacity(true);
    }
};
...
Window_Status.prototype.drawBasicInfo = function(x, y) {
    var lineHeight = this.lineHeight();
    this.drawActorLevel(this._actor, x, y + lineHeight * 0.8);
...
Window_SavefileList.prototype.drawItem = function(index) {
    ...
    this.drawFileId(id, rect.x, rect.y, info);
    if (info) {
        this.drawContents(info, rect, valid);
    }
};

Window_SavefileList.prototype.drawFileId = function(id, x, y, info) {
...
Window_SavefileList.prototype.drawGameTitle = function(info, x, y, width) {
    console.log(this);
    //       this.changeTextColor(info.colorIndex);
    if (info.fileName) {
        this.drawText(info.fileName, x, y, width);
    }
};
...
Window_BattleLog.prototype.windowWidth = function() {
    return Graphics.boxWidth*.7;
};

Window_BattleLog.prototype.windowHeight = function() {
    return this.fittingHeight(this.maxLines())*.3;
};
...
Window_BattleLog.prototype.messageSpeed = function() {
    if ($gameSwitches.value(99)|| $gameSwitches.value(98)|| $gameSwitches.value(97)) {
        return 8;
    }
    else{
        return 16;
...
Window_BattleLog.prototype.drawBackground = function() {
    ...
    //    this._backBitmap.fillRect(rect.x, rect.y-20, rect.width, rect.height*2, color);
...
Window_BattleLog.prototype.displayAction = function(subject, item) {
    ...
    $gameVariables.setValue(85, subject.name());
    if (DataManager.isSkill(item)) {
        if (item.message1) {
...
Window_BattleLog.prototype.displayAddedStates = function(target) {
    target.result().addedStateObjects().forEach(function(state) {
        ...
        // If the state is the death state, perform collapse
        ...
        if (state.id === 29) {
            ...
            if(target._classId === 1)
            {
                if ($gameSwitches.value(164)) { 
                    return;
                }

                $gameSwitches.setValue(164, true);
            }

            if(target._classId === 2)
            {
                if ($gameSwitches.value(165)) { 
                    return; 
                }
                $gameSwitches.setValue(165, true);
            }

            if(target._classId === 3)
            {
        ...
        // If the state has a message, add it to the log
        if (stateMsg && BattleManager._phase=="actionTargetList") {
            this.push('popBaseLine');
            this.push('pushBaseLine');
...
// Clear the displayedStates array at the start of each new turn
BattleManager.startTurn = function() {
    displayedStates = [];  // Clear the array when a new turn starts
    this._phase = 'turn';  // Set the phase to 'turn'
    this._actionBattlers = [];
    this._logWindow.clear();
    this._turnCount++;
    this._logWindow.push('addText', 'Turn ' + this._turnCount);
...
Window_BattleStatus.prototype.drawGaugeAreaWithTp = function(rect, actor) {
    this.drawActorHp(actor, rect.x + 123, rect.y, 108);
    //    this.drawActorMp(actor, rect.x + 123, rect.y, 96);
    //    this.drawActorTp(actor, rect.x + 234, rect.y, 96);
};

Window_BattleStatus.prototype.drawGaugeAreaWithoutTp = function(rect, actor) {
    this.drawActorHp(actor, rect.x + 216, rect.y, 201);
