...
Sprite_Enemy.prototype.update = function() {
    ...
    this._floatDur = (this.x + this.y+this._svRand+this.spriteId) % 7;
    this._height+=1;
    this._floatRate= this.x;


    if (this._height>20 + this._floatDur && this._height<38 + this._floatDur){
        this.x+=1;

    }
    else if (this._height>38 + this._floatDur){
        this._height=0;
    }
...
Sprite_Enemy.prototype.updateStateSprite = function() {
    if ($gameSwitches.value(168)) {
        this._stateIconSprite.y = -Math.round((this.bitmap.height + 40) * 0.51);
    } else {
        this._stateIconSprite.y = -Math.round((this.bitmap.height + 40) * 0.9)+12;
    }
